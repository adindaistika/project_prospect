...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      <div
        style={{
          background: "linear-gradient(180deg, #4097D7 0.19%, #216EA6 99.81%)",
        ...
        <div className=" rounded-lg overflow-hidden  bg-white w-full sm:w-1/2">
          ...
          {data_event_terupdate.length > 0 ? (
            data_event_terupdate.map((item, i) => (
              <div className="hover:bg-sky-100 border-b-2 border-slate-100 p-3 flex justify-between items-center">
                <div>
